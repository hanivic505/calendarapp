...
angular.module('app')
  .service('LocalStorageService', __webpack_require__(21));
...
angular
  ...
  .controller('ModalInstanceController', ["$uibModalInstance", "events", function ($uibModalInstance, events) {
    var vm = this;
    vm.events = events;
